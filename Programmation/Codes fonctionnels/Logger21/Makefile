...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Sat Apr 13 17:05:18 2013
# Project:  Logger21.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile Logger21.pro
#############################################################################
...
Makefile: Logger21.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile Logger21.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Logger211.0.0/ && $(COPY_FILE) --parents tablemgr.h FenPrincipale.h dialog.h defines.h UI/mapsview.h UI/boardingtable.h InPut/serial.h InPut/sensorvalue.h InPut/sensormanager.h InPut/sensor.h InPut/fileimportdialog.h ../ChronoReaderWidget/chronoreaderwidget.h ../ChronoReaderWidget/TimeCalcs/timecalcs.h ../ChronoReaderWidget/eventbox.h UI/graphicview.h .tmp/Logger211.0.0/ && $(COPY_FILE) --parents FenPrincipale.cpp dialog.cpp tablemgr.cpp main.cpp UI/mapsview.cpp UI/boardingtable.cpp InPut/serial.cpp InPut/sensorvalue.cpp InPut/sensormanager.cpp InPut/sensor.cpp InPut/fileimportdialog.cpp ../ChronoReaderWidget/chronoreaderwidget.cpp ../ChronoReaderWidget/TimeCalcs/timecalcs.cpp ../ChronoReaderWidget/eventbox.cpp UI/graphicview.cpp .tmp/Logger211.0.0/ && $(COPY_FILE) --parents FenPrincipale.ui dialog.ui InPut/fileimportdialog.ui ../ChronoReaderWidget/chronoreaderwidget.ui ../ChronoReaderWidget/eventbox.ui .tmp/Logger211.0.0/ && (cd `dirname .tmp/Logger211.0.0` && $(TAR) Logger211.0.0.tar Logger211.0.0 && $(COMPRESS) Logger211.0.0.tar) && $(MOVE) `dirname .tmp/Logger211.0.0`/Logger211.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Logger211.0.0
